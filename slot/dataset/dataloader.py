...
def get_libero_image_dataloader(dataset_path: str,
    ...
    dataset = LiberoImageDataset(dataset_path=dataset_path,
                                       view=view,
                                       val_ratio=val_ratio,
                                       seed=seed)
    val_dataset = dataset.get_val_dataset()
    train_loader = DataLoader(dataset, batch_size=train_batch_size, shuffle=True, num_workers=train_num_workers, pin_memory=train_pin_memory, persistent_workers=train_persistent_workers)
...
def get_libero_subgoal_image_dataloader(dataset_path: str,
                                        ...
                                        val_pin_memory: bool=True,
                                        val_persistent_workers: bool=False) -> DataLoader:
    dataset = LiberoSubgoalImageDataset(dataset_path=dataset_path,
                                       view=view,
                                       val_ratio=val_ratio,
                                       seed=seed)
    val_dataset = dataset.get_val_dataset()
